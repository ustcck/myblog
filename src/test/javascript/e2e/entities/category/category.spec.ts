...
describe('Category e2e test', () => {
    ...
    it('should load Categories', () => {
        ...
        expect(categoryComponentsPage.getTitle()).toMatch(/personalBlogApp.category.home.title/);
    });

    it('should load create Category page', () => {
        categoryComponentsPage.clickOnCreateButton();
        categoryUpdatePage = new CategoryUpdatePage();
        expect(categoryUpdatePage.getPageTitle()).toMatch(/personalBlogApp.category.home.createOrEditLabel/);
    ...
    it('should create and save Categories', () => {
        ...
        categoryUpdatePage.userSelectLastOption();
