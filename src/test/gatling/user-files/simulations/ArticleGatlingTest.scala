...
class ArticleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Article entity")
        ...
        .repeat(2) {
            ...
            .post("/api/articles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "summary":"SAMPLE_TEXT", "content":null, "click":"0", "create":"2020-01-01T00:00:00.000Z", "update":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
